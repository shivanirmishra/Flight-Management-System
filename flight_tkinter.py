...
def BookTickets():
    ...
    # box.configure("center", justify='center')
    ...
    def Oneway():
        ...
        # n4 = StringVar() 
        # Label(box1, text='Type: ').grid(row=13) 
        # Type1 = Combobox(box1,height=5,textvariable=n4)
        ...
        def calcmon():
            ...
            if int(weight)>20:
                money = 2 *int(weight)
                print("Money in Rupees",money)
            else:
                print("Money","No extra money!")
        ...
        def confirm():
            ...
            if name=='' or adhar=='' or Source=='' or Destination == '' or Date == ''or Time == '' or Class =='':
                ...
                if Source == Destination:
                    print("Error","Source can not be same as Destination!")
                else:
                    if Class == 'Economy':
                        print(Class)
                        insert.execute("insert into ECONOMY values(?,?,?,?,?,?)",x)
                        print("Payment Successful","Your Seat is Confirmed!")
                        con.commit()
                        box1.destroy()
                    if Class == 'Business':
                        print(Class)
                    ...
                    if Class == 'First-Class':
                        ...
                        print("Payment Sucessful","Your Seat is Confirmed!")
                        con.commit()
                        box1.destroy()
        ...
        if name == '' or adhar == '' or Source == '':
            ...
            if Type == 'One-Way':
                if Class == 'Economy':
                    ...
                    con.commit()
                    print("Cancel","your reservation is cancelled")
